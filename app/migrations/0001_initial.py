    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(choices=[('faridabad', 'faridabad'), ('gurugram', 'gurugram'), ('ambala', 'ambala'), ('karnal', 'karnal'), ('hisar', 'hisar'), ('panipat', 'panipat')], default='faridabad', max_length=50)),
                ('groups', models.ManyToManyField(blank=True, related_name='app_user', to='auth.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incident_modify_date', models.DateField()),
